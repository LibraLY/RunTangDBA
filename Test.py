...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setTabOrder(self.excelButton, self.OutButton)
        MainWindow.setTabOrder(self.OutButton, self.aboutButton)
